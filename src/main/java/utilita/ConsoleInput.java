 ...
 * Un oggetto istanza della classe console input espone dei metodi che consentono di acquisire dalla tastiera variabili
 * di ciascun dato nativo (int, short, ecc.) e oggetti di tipo String
 * @author Plona
 */
